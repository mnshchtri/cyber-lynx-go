...
const Sidebar = ({ isCollapsed, toggleSidebar, isMobileNavOpen, toggleMobileNav }) => {
  ...
  return (
    <aside id="sidebar" className={sidebarClasses}>
      <div className="p-4 flex items-center justify-between h-18 border-b border-gray-200 dark:border-gray-700">
      ...
      <nav className="mt-6 flex-grow">
        <div className="px-4 mb-4">
          <button onClick={handleLinkClick} className="w-full flex items-center justify-center py-2 px-4 bg-gradient-to-r from-primary to-primary-dark text-white rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-px transition-all duration-200">
        ...
        <ul className="space-y-2">
          <li>
            <Link to="/" onClick={handleLinkClick} className={`flex items-center py-2 px-4 ${isActive('/') ? 'text-white bg-primary rounded' : 'text-text-secondary hover:bg-gray-200 hover:text-text-primary'} transition-colors duration-200`} data-tooltip="Dashboard">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
              <span className={`ml-3 ${isCollapsed ? 'md:hidden' : ''}`}>Dashboard</span>
            </Link>
          </li>
          <li>
            <Link to="/workflow" onClick={handleLinkClick} className={`flex items-center py-2 px-4 ${isActive('/workflow') ? 'text-white bg-primary rounded' : 'text-text-secondary hover:bg-gray-200 hover:text-text-primary'} transition-colors duration-200`} data-tooltip="Workflow">
          ...
          <li>
            <a href="#" onClick={() => setModesOpen(!modesOpen)} className="flex items-center py-2 px-4 text-text-secondary hover:bg-gray-200 hover:text-text-primary transition-colors duration-200" data-tooltip="Modes">
              ...
              <svg className={`w-4 h-4 ml-auto transform transition-transform duration-200 ${modesOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
            </a>
            <ul className={`ml-8 mt-1 space-y-1 ${modesOpen ? '' : 'hidden'}`}>
          ...
          <li>
            <a href="#" onClick={() => setPayloadsOpen(!payloadsOpen)} className="flex items-center py-2 px-4 text-text-secondary hover:bg-gray-200 hover:text-text-primary transition-colors duration-200" data-tooltip="Payloads">
              ...
              <svg className={`w-4 h-4 ml-auto transform transition-transform duration-200 ${payloadsOpen ? 'rotate-90' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7"></path></svg>
            </a>
            <ul className={`ml-8 mt-1 space-y-1 ${payloadsOpen ? '' : 'hidden'}`}>
          ...
          <li>
            <Link to="/reports" onClick={handleLinkClick} className={`flex items-center py-2 px-4 ${isActive('/reports') ? 'text-white bg-primary rounded' : 'text-text-secondary hover:bg-gray-200 hover:text-text-primary'} transition-colors duration-200`} data-tooltip="Reports">
          ...
          <li>
            <Link to="/profile" onClick={handleLinkClick} className={`flex items-center py-2 px-4 ${isActive('/profile') ? 'text-white bg-primary rounded' : 'text-text-secondary hover:bg-gray-200 hover:text-text-primary'} transition-colors duration-200`} data-tooltip="Profile">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
              <span className={`ml-3 ${isCollapsed ? 'md:hidden' : ''}`}>Profile</span>
            </Link>
          </li>
          <li>
            <Link to="/settings" onClick={handleLinkClick} className={`flex items-center py-2 px-4 ${isActive('/settings') ? 'text-white bg-primary rounded' : 'text-text-secondary hover:bg-gray-200 hover:text-text-primary'} transition-colors duration-200`} data-tooltip="Settings">
          ...
          <li>
            <a href="#" onClick={handleLinkClick} className="flex items-center py-2 px-4 text-text-secondary hover:bg-gray-200 hover:text-text-primary transition-colors duration-200" data-tooltip="Logout">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <button onClick={toggleDarkMode} className="w-full mb-2 py-2 px-4 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-md text-text-primary flex items-center justify-center transition-colors duration-200">
          {darkMode ? (
          ...
          <span className={`ml-2 ${isCollapsed ? 'hidden' : ''}`}>{darkMode ? 'Light Mode' : 'Dark Mode'}</span>
        </button>
        <button onClick={toggleSidebar} id="sidebar-toggle" className="w-full mt-2 py-2 px-4 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-md text-text-primary hidden md:flex items-center justify-center transition-colors duration-200">
          ...
          <span className={`ml-2 ${isCollapsed ? 'hidden' : ''}`}>{isCollapsed ? 'Expand' : 'Collapse'}</span>
        </button>
      </div>
    </aside>
  );
